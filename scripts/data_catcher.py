...
with open(full_path, mode='w', newline='') as file:
    ...
    # accelerometer, temp, audio
    writer.writerow(['Accel_X', 'Accel_Y', 'Accel_Z', 'Temperature_C', 'Audio_Amp'])
    ...
    try:
        ...
        while time.time() - start_time < (3 * 3600): # (3 * 3600) = 3 hours
            if ser.in_waiting > 0:
                ...
                # validate that there's the 5 data points before saving
                if len(data_points) == 5:
                    ...
                    colored_output = (
                        ...
                        f"{C['YELLOW']}{data_points[4]:>7}{C['RESET']}"
                    )
